...
class GeodesicRegression(BaseEstimator):
    ...
    def __init__(
        ...
        self.geodesic_residuals = geodesic_residuals
    ...
    def _fit_extrinsic(self, X, y, weights=None, compute_training_score=False):
        ...
        print("objective with grad")
        print(objective_with_grad)
        print(objective_with_grad(initial_guess))
    ...
    def initialize_parameters(self, y):
        ...
        if isinstance(init, str):
            ...
            if init == "frechet":
                mean = FrechetMean(self.space).fit(y).estimate_
    ...
    def _fit_riemannian(self, X, y, weights=None, compute_training_score=False):
        ...
        objective_with_grad = gs.autodiff.value_and_grad(
            lambda params: self._loss(X, y, params, shape, weights), to_numpy=True
        )
