...
def load(config):  # , device = "cuda:0"):
    ...
    if config.dataset_name == "synthetic":
        ...
        mesh_dir = default_config.sorted_parameterized_dir
        mesh_sequence_vertices = []
        mesh_sequence_faces = []
        ...
        hormone_levels_path = os.path.join(
            default_config.sorted_parameterized_dir, "sorted_hormone_levels.npy"
        )
        ...
        for i_mesh in range(last_day - first_day + 1):
            ...
            #     default_config.sorted_parameterized_dir,
            ...
            mesh_path = os.path.join(default_config.sorted_parameterized_dir, file_name)
            [
                vertices,
                faces,
                Fun,
