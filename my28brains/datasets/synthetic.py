...
def y_hypersphere():
    ...
    y = gs.array([[ 0.9211,  0.3862,  0.0488],
    ...
    X = gs.array([ 0.4575,  0.1953, -0.0532,  0.4082,  0.1325,  0.2786, -0.3340, -0.1615,
        0.0688, -0.2243, -0.0597, -0.3358, -0.1573,  0.1093, -0.0307, -0.0718,
        -0.1053, -0.3071,  0.1525,  0.2723, -0.3022,  0.1642, -0.4028,  0.0112,
        -0.2865,  0.0457,  0.0750,  0.1694,  0.2328, -0.2849,  0.2973,  0.1180,
        -0.3167, -0.3598, -0.0311,  0.4049,  0.0595, -0.0317,  0.2835, -0.1446,
        -0.2404, -0.4711,  0.2361, -0.1708,  0.0257, -0.0462,  0.3509, -0.4715,
        0.4847,  0.3671])
    return X, y

def fixed_hyperboloid_data():
    """Return 50 X,y pairs on the hyperboloid."""
    y = gs.array([[1.2597, 0.6713, 0.3693],
