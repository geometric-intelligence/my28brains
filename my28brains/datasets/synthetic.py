...
import my28brains.discrete_surfaces_old
...
def generate_synthetic_parameterized_geodesic(start_mesh, end_mesh, n_times=5):
    """Generates a synthetic geodesic between two parameterized meshes.
    input:
...
def generate_unparameterized_synthetic_geodesic(start_mesh, end_mesh, n_times=5):
    """Generates a synthetic geodesic between two unparameterized meshes."""
