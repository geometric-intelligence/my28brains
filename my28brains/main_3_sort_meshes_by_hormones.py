...
for i_mesh in range(first_day, last_day + 1):
    mesh_path = os.path.join(
        ...
        f"{default_config.hemisphere[0]}_structure_-1_day{i_mesh:02d}"
        "_at_0.0_parameterized.ply",
    )
    [
        vertices,
        faces,
...
sorted_hormone_levels_path = os.path.join(
    sorted_parameterized_meshes_dir, "sorted_hormone_levels.npy"
)
